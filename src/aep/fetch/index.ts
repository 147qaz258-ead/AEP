 ...
 */
function validateEnvelope(envelope: AEPEnvelope): void {
 ...
 */
function extractAgentId(authHeader: string | undefined): string | null {
 ...
 */
function toExperienceSummary(result: MatchResult): ExperienceSummary {
...
export class FetchHandler {
  ...
  private readonly validateAgent: AgentValidatorFn;
  private readonly updateAgentLastSeen: AgentUpdateFn;
   ...
   */
  private async authenticate(context?: FetchContext): Promise<string> {
