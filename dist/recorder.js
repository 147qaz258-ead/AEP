...
exports.SessionRecorder = exports.StorageManager = exports.SessionNotFoundError = exports.SessionNotActiveError = exports.SessionError = void 0;
 ...
 */
class SessionNotActiveError extends SessionError {
    constructor(message) {
        super(message);
        this.name = 'SessionNotActiveError';
    }
}
exports.SessionNotActiveError = SessionNotActiveError;
/**
...
class SessionRecorder {
    ...
    startSession(metadata) {
        ...
        // Create new session
        const sessionId = `session_${(0, types_1.generateId)()}`;
        this.activeSession = (0, types_1.createSession)({
            id: sessionId,
